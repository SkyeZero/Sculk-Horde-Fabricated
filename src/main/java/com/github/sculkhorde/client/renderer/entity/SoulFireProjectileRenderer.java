...
public class SoulFireProjectileRenderer extends GeoEntityRenderer<SoulFireProjectileAttackEntity> {
    ...
    @Override
    public void actuallyRender(PoseStack poseStack, SoulFireProjectileAttackEntity animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        poseStack.pushPose();
